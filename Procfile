...
worker: celery -A django_celery_example beat -l info --without-gossip --without-mingle --without-heartbeat --scheduler django_celery_beat.schedulers:DatabaseScheduler
